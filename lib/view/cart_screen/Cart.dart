import 'package:nyasa/Common_Widgets/animation/animation_switch.dart';
import 'package:nyasa/constents/consts.dart';
import 'package:nyasa/view/cart_screen/EmptyCart.dart';
import 'package:nyasa/view/controller/models/extensions.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Expanded(
            child:
                !controller.isEmptyCart ? cartList() : const EmptyCartScreen(),
          ),
          bottomBarTitle(),
          bottomBarButton()
        ],
